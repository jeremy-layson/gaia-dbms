<?php  
    include('Class_12_1_6.php');
    $class = new Class_12_1_6();
    $data = $class->getData();
?>
...
<table border="1">
    ...
    <thead>
        <tr>
            ...
            <td colspan="12">Marginally Affected</td>
            <td colspan="12">Severely Affected</td>
            <td rowspan="3">Total Cost</td>
        </tr>
        <tr>
            <td colspan="3">Light</td>
            <td colspan="3">Semi</td>
