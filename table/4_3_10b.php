<?php  
    include('Class_4_3_10b.php');
    $class = new Class_4_3_10b();
    $data = $class->getData();
?>
...
<table border="1">
    <h3>Table 4.3-10b - Monthly Expenditure of Legal PAFs (LGU Level)</h3>
    <thead>
        <tr>
...
<table border="1">
    <h3>Table 4.3-10b - Monthly Expenditure of Legal PAFs (Baranggay Level)</h3>
    <thead>
        <tr>
            <td>Municipalities and Cities</td>
            <td>Baranggay</td>
