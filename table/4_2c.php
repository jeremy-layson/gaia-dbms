<?php  
    include('Class_4_2c.php');
    $class = new Class_4_2c();
    $data = $class->getData();
?>
...
<html>
<head>
    <title>Table 4.2 Number of PAFs and PAPs by LGUs (Valenzuela Depot)</title>
...
<table border="1">
    <h3>Table 4.2 Number of PAFs and PAPs by LGUs (Valenzuela Depot)</h3>
    <thead>
        <tr>
            <td rowspan="2" colspan="2">City/Municipality</td>
