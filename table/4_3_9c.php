<?php  
    include('Class_4_3_9c.php');
    $class = new Class_4_3_9c();
    $data = $class->getData();
?>
...
<table border="1">
    <h3>Table 4.3-9c - Monthly Income of ISFs (LGU Level)</h3>
    <thead>
        <tr>
...
<table border="1">
    <h3>Table 4.3-9c - Monthly Income of ISFs (Baranggay Level)</h3>
    <thead>
        <tr>
            <td rowspan="2">Municipalities and Cities</td>
